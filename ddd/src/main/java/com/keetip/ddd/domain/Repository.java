 ...
 * 
 */
public interface Repository<T extends Entity<K>, K extends Object> {

	public T load(K primaryKey) throws EntityNotFoundException;

	public void add(T entity) throws RepositoryDataAccessException;
